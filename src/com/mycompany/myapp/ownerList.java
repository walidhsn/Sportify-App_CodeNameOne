...
public class ownerList extends Form {
    ...
    public ownerList(Resources theme) {
        ...
        ArrayList<Terrain> terrains = ServiceTerrain.getInstance().afficherTerrains_owner(SharedComponents.user.getId());
        ...
        for (Terrain terrain : terrains) {
            ...
            view.addActionListener(e -> {
                    ...
                    removeAll();
                    new Terrain_details(theme,terrain).show();
                
            });
            edit.addActionListener(e -> {
                try {
                    removeAll();
                    new EditTerrain(theme,terrain).show();
