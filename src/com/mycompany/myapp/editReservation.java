 ...
 * @author WALID
 */
public class editReservation extends Form {
    ...
    public editReservation(Resources theme, Reservation reservation) {
        ...
        numPeopleField.setText(String.valueOf(reservation.getNbPerson()));
